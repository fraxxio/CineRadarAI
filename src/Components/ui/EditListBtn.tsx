...
export default function EditListBtn({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger className="h-10 w-full rounded-md border border-border-clr bg-dark-bg px-3 py-2 font-medium duration-200 hover:bg-primary-text hover:text-dark-bg">
        <Pencil size={16} />
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
